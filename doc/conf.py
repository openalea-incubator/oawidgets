...
# -*- coding: utf-8 -*-
#
# Package oawidgets documentation build configuration file, created by
...
htmlhelp_basename = "oawidgetsdoc"
...
# [howto/manual]).
latex_documents = [
    (u"index", u"oawidgets.tex",
     u"oawidgets Documentation",
     u"Baptiste Brument", u"manual"),
]
...
texinfo_documents = [
    (u"index", u"oawidgets",
     ...
     u"Baptiste Brument",
     u"oawidgets",
     u"OpenAlea Widgets for IPython Kernel",
     u"Miscellaneous"),
]
